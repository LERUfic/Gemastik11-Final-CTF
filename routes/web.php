...
Route::middleware(['auth'])->group(function (){
	...
	Route::prefix('peserta')->group(function () {
		...
		Route::get('/permainan', 'FlagController@viewFormSubmit')->name('flag.game');
		Route::post('/permainan', 'FlagController@submitYourFlag')->name('flag.gamein');

		Route::get('/myscore', 'FlagController@getAllPoin')->name('flag.score');
